import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Image, ViewPagerAndroidBase } from 'react-native'
...
const BonSortieScreen = ({ navigation }) => {
  ...
  const FetchAPI = async () => {
    await axios.get(`${API}/bonsorties/get`)
    .then((result) => {
      if(result.data.success){
        setData(result.data.bonSorties)
      }
    })
  }

  const handleDelete = async (id) => {
    await axios.delete(`${API}/bonsorties/remove/${id}`)
    .then((response) => {
            ...
            <View style={styles.cardView}>
               {
                ...
                <View style={styles.cardcontent}>
                  <Image style={styles.cardimage} source={require('./../../../assets/bonsortie.jpg')} />
                </View>
                    ...
                    <View style={styles.cardDetails}>
                      ...
                      <Text style={{ fontSize:15, color:'#333', marginBottom:5}}>Date limite de sortie : {item.dateLimiteSortie}</Text>
                      <Text style={{ fontSize:15, color:'#333', marginBottom:5}}>Tonnage à enlever : {item.tonnageAEnlever} Ton</Text>
                      {
                    ...
                    <View style={styles.cardaction}>
                      ...
                      <Button icon="tooltip-edit-outline" mode="text" compact={true} color={Colors.blue500} onPress={() => navigation.navigate('BonSortieForm', {action:'Edit', id: item._id})}>
                        Modifier
                      </Button>
