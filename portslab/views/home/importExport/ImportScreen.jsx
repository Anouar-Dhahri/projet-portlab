  ...
  return (
    <View style={{ flex: 1 }}>
      <FAB
        ...
        animated={true}
        visible={true}
        onPress={() => navigation.navigate("ImportFormScreen", { user: route.params.user, action:"create"})}
      />
            ...
            <View style={styles.cardView}>
               {
                ...
                <View style={styles.cardaction}>
                  <Button icon="tooltip-edit-outline" mode="text" compact={true} color={Colors.blue500} onPress={() => navigation.navigate('ImportFormScreen', {action:'Edit', id: trade._id})}>
                    Modifier
                  </Button>
